...
export const HUD: React.FC = () => {
  const { score, lives, maxLives, collectedLetters, status, level, restartGame, startGame, gemsCollected, distance, isImmortalityActive, speed, setUsername } = useStore();
                ...
                <div className="relative w-full bg-gray-900">
                     ...
                     <div className="absolute inset-0 flex flex-col justify-end items-center p-6 pb-8 text-center z-10">
                        <input
                          ...
                          className="w-full px-4 py-3 mb-4 bg-black/50 text-white border-2 border-cyan-400 rounded-lg text-center"
                        />
                        <button
                          onClick={() => {
                            setUsername(name);
